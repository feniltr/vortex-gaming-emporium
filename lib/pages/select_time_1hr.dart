...
class Select_Time_1hr extends StatefulWidget {
   Select_Time_1hr({Key? key}) : super(key: key);

  @override
  State<Select_Time_1hr> createState() => _Select_Time_1hrState();
}

class _Select_Time_1hrState extends State<Select_Time_1hr> {
              ...
              children: [
                GestureDetector(
                  onTap: (){
                    ...
                    {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => PrivateRoomScreen(timeSlot: selectedtime,)));
                    }
